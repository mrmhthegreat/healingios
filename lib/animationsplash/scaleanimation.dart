...
class _ScaleSplashState extends State<ScaleSplash> {
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      statusBarColor: Color.fromRGBO(28, 9, 31, 1).withOpacity(0.4),
      statusBarBrightness: Brightness.light,
      statusBarIconBrightness: Brightness.light,
      systemNavigationBarColor: Color.fromRGBO(16, 46, 55, 1),
      systemNavigationBarDividerColor: Color.fromRGBO(16, 46, 55, 1),
